...
<!-- Mittlerer Teil --------------------------------------------------------------------------->
    ...
    <a href="#">
		<img src="images/chevron.png" id="chevronup" class="chevronup"  style="transition-duration: 1s;position:fixed; z-index: 999; bottom:25px; right:11%;" alt="Pfeil nach oben" />
	</a>
