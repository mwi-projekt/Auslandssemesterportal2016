				...
				success : function(result) {
					...
					for (var i = 0; i < row.length; i++){
						...
						if ((instance_info[2] === "Abgeschlossen")||(instance_info[2] === "Auf Rückmeldung warten")){
							//Übersicht
							tabelle = tabelle + '<td><span class="btn glyphicon glyphicon-list" title="Übersicht" onclick="location.href=\'task_detail.html?instance_id=' + instance_info[0] + '\'"></span></td>';
						} else if (instance_info[2] === "Daten prüfen"){
								//Übersicht
								tabelle = tabelle + '<td><span class="btn glyphicon glyphicon-list" title="Übersicht" onclick="location.href=\'task_detail.html?instance_id=' + instance_info[0] + '&send_bew=true\'"></span><td>';
								//Prozess löschen
