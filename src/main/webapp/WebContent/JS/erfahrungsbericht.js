  ...
  $(document).ready(function() {
	...
	// hier wird der Anzahl der Sternen ausgew�hlt
	...
	//frageID, Anzahl der Sternen, Matrikelnummer, Frage,  Antwort und Bildern von HTML speichern und  an erfahrungsberichtInhalt_db.java �bergeben
	...
	$('.btn').on('click', function() {
		...
		//ID X1 geh�rt zu Button: " Erfaruhngsbericht abschli�en" und wird nur dann ausgef�hrt, wenn
		//dann dieser Button bei Erfahrungsbericht4.html gedr�ckt wird.
		/* if(id == x1){
