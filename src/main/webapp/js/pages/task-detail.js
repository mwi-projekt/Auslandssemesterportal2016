...
$(document).ready(function () {
  ...
  $('#validateBtn').on('click', function () {
    ...
    if (grund.indexOf('Platzhalter') < 0 || grund.indexOf('--') < 0) {
      Swal.fire({
        title: 'Platzhalter',
...
function parse() {
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      output = output + '<div class="" id="accordion">';
        ...
        if (data.search('id') != -1) {
          ...
          if (innerOutput != '') {
            ...
            output =
              ...
              '<div class="card" id="' +
              visibleStepName +
              '"><div class="card-header"><h4 class="card-title"><a data-toggle="collapse" href="#collapse' +
              k +
              '">' +
              visibleStepName +
              '</a></h4></div>'; // Header
      ...
      output =
        output +
        '<div class="card"><div class="card-header"><h4 class="card-title"><a data-toggle="collapse" href="#collapse-downloads">Dateien</a></h4></div>'; // Header
      output =
        output +
