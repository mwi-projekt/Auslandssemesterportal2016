        ...
        <div class="row">
          <div class="col-sm-6 col-md-8">
            <nav class="quicklinks">
              <h3>Quicklinks</h3>
              <nav id="c4" class="csc-frame csc-frame-default menu_pages">
                <ul class="csc-menu csc-menu-def">
                  <li>
                    ...
                    <a href="https://www.karlsruhe.dhbw.de/international-office/veranstaltungen-und-aktuelles.html#anchor-main-content" title="Weitere Infos">Weitere Informationen</a>
                  </li>
                </ul>
              </nav>
            </nav>
          ...
          <div class="col-sm-6 col-md-4">
            <nav class="sociallinks">
              ...
              <p>
                ...
                <br />
                <br />
                <a href="mailto:info@dhbw-karsruhe.de"
                >info@dhbw-karsruhe.de</a
                >
              </p>
            </nav>
          </div>
