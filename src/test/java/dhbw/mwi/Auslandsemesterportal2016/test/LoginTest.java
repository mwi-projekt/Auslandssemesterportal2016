...
public class LoginTest {
    /*
    //Test-User Studiengangsleiter
    private static String testSgl_correctMail = "test@sgl.dhbw-karlsruhe.de";
    private static String testSgl_correctPw = "Hallo1234!";

    //Test-User AAA-Mitarbeiter
    private static String testAAA_correctMail = "auslandsamt@dh-karlsruhe.de";
    private static String testAAA_correctPw = "AuslandsMa1234!";

    //Test-User Admin
    private static String testAdmin_correctMail = "admin@admin.de";
    private static String testAdmin_correctPw = "admin";
    */
    ...
    public void failedLoginBecauseOfFalseMail() {
        ...
        String[] result = SQL_queries.userLogin(testUser_falseMail, salt, testUser_correctPw);
    ...
    public void failedLoginBecauseOfFalsePassword() {
        String salt = SQL_queries.getSalt(testUser_correctMail);
        String[] result = SQL_queries.userLogin(testUser_correctMail, salt, testUser_falsePw);
    ...
    public void failedLogin() {
        String salt = SQL_queries.getSalt(testUser_falseMail);
        String[] result = SQL_queries.userLogin(testUser_falseMail, salt, testUser_falsePw);
