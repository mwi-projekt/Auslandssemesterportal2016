...
public class UserUpdateServletTest {
    ...
    // sql_queries.when(() -> SQL_queries.checkUserSession(any(),
    // any())).thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.executeStatement(any(), any(),
    // any())).thenReturn(resultSet);
    // sql_queries.when(() ->
    // SQL_queries.getRoleForUser(any())).thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateMA(any(), any(), any(), any(),
    // any())).thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateMA(any(), any(), any(), any(),
    // any(), any())).thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateStud(any(), any(), any(), any(),
    // any(), any())).thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateStud(any(), any(), any(), any(),
    // any(), any(), any()))
    // .thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateUser(any(), any(), any(), any(),
    // any(), any(), any(), any()))
    // .thenCallRealMethod();
    // sql_queries.when(() -> SQL_queries.updateUser(any(), any(), any(), any(),
    // any(), any(), any()))
    ...
    // */
    // @Test
    // public void testDoPostForAdminWithOldmail0AndRole2() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "0";
    // String role = "2";
    ...
    // public UserUpdateServlet callProtectedMethod(HttpServletRequest request,
    ...
    // @Test
    // public void testDoPostForAdminWithOldmail0AndRole4() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "0";
    // String role = "4";
    ...
    // @Test
    // public void testDoPostForAdminWithOldmail0AndRole6() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "0";
    // String role = "6";
    ...
    // @Test
    // public void testDoPostForAdminWithOldmail2AndRole2() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "2";
    // String role = "2";
    ...
    // @Test
    // public void testDoPostForAdminWithOldmail2AndRole4() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "2";
    // String role = "4";
    ...
    // @Test
    // public void testDoPostForAdminWithOldmail2AndRole6() throws IOException,
    // SQLException {
    // // set up request data
    // String oldmail = "2";
    // String role = "6";
    ...
    // @Test
    // public void testDoPostWithOldmail0AndUpdateError() throws SQLException,
    // IOException {
    // // set up request data
    // String oldmail = "0";
    // String role = "6";
    ...
    // @Test
    // public void testDoPostWithOldmail2AndUpdateError() throws SQLException,
    // IOException {
    // // set up request data
    // String oldmail = "2";
    // String role = "6";
