...
public class UserUpdateServletTest {
    ...
    /*
     * Test doPost()-Method for rolle=2 (Mitarbeiter)
     */
    @Test
    public void testDoPostForMAWithOldmail0AndRole2() throws IOException, SQLException {
        // set up request data
        String oldmail = "0";
        String role = "2";
    ...
    @Test
    public void testDoPostForMAWithOldmail0AndRole4() throws IOException, SQLException {
        // set up request data
        String oldmail = "0";
        String role = "4";
    ...
    @Test
    public void testDoPostForMAWithOldmail0AndRole6() throws IOException, SQLException {
        // set up request data
        String oldmail = "0";
        String role = "6";
    ...
    @Test
    public void testDoPostForMAWithOldmail2AndRole2() throws IOException, SQLException {
        // set up request data
        String oldmail = "2";
        String role = "2";
    ...
    @Test
    public void testDoPostForMAWithOldmail2AndRole4() throws IOException, SQLException {
        // set up request data
        String oldmail = "2";
        String role = "4";
    ...
    @Test
    public void testDoPostForMAWithOldmail2AndRole6() throws IOException, SQLException {
        // set up request data
        String oldmail = "2";
        String role = "6";
